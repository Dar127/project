...
\"<b>$nim</b>\" sudah berhasil ditambahkan";
...
<body class="bg-light">
    <div class="container mt-5 border rounded bg-white py-4 px-5 mb-5">
        <header class="header-title mb-4">
            <h1><a href="./form.php" style="text-decoration:none;">
                <span class="fw-normal text-dark">Sistem Informasi</span> 
                <span class="textprimary">Mahasiswa</span></a></h1>
            <hr>
        </header>
        <section>
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form">
                ...
                <div class="mb-3">
                    <label for="tempat_lahir" class="form-label">Tempat
                        Lahir</label>
                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" value="<?php echo (isset($tempat_lahir)) ?
                        $tempat_lahir : ""; ?>" placeholder="Masukkan Tempat Lahir">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div>
                        <label for="jenis_kelamin" class="form-label">JenisKelamin</label>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <span class="text-muted">(angka desimal dipisah dengan
                        karakter titik ".")</span>
                </div>
                <br>
                <div class="mb-3">
